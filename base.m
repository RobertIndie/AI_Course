...
A=[864.45 877.88 1418.79 1449.58;%R
1647.31 2031.66 1775.89 1641.58;%G
2665.9  3071.18  2772.9 3045.12]; % B A belongs to w1
B=[2352.12 2297.28 2092.62 2205.36 2949.16 2802.88 2063.54  2557.04 3340.14 3177.21 3243.74 3244.44 3017.11 3199.76  1411.53 535.62 584.32 1202.69 662.42 1984.98 1257.21]; %B belongs to w2
C=[1739.94 1756.77 1803.58 1571.17 1845.59 1692.62 1680.67 1651.52 1675.15 1652 1583.12 1731.04 1918.81 1867.5 1575.78 1713.28  2395.96 1514.98 2163.05 1735.33 2226.49 2108.97 1725.1 1570.38]; %C belongs to w3
D=[373.3 222.85 401.3 363.34 104.8 499.85 172.78 341.59 291.02 237.63 3087.05 3059.54 3259.94 3477.95 3389.83 3305.75 3084.49 3076.62 3095.68 3077.78 2429.47 2002.33 2150.98 2462.86 2421.83 3196.22 2328.65 2438.63 2088.95 2251.96]; % D belongs to w4
%以上为学习样本数据的输入
X1=mean(A')';X2=mean(B')';X3=mean(C')';X4=mean(D')'; %求样本均值
S1=cov(A');S2=cov(B');S3=cov(C');S4=cov(D'); %求样本协方差矩阵
S1_=pinv(S1);S2_=pinv(S2);S3_=pinv(S3);S4_=pinv(S4); % 求协方差矩阵的逆矩阵
S11=det(S1);S22=det(S2);S33=det(S3);S44=det(S4); %  求协方差矩阵的行列式
Pw1=N1/N;Pw2=N2/N;Pw3=N3/N;Pw4=N4/N; %先验概率
%这部分为初始样本数据计算
  sample=[1702.8 1639.79 2068.74
            ...
            1860.45 1782.88 1875.13];%这部分为30个测试数据输入
for k=1:30
